...
public class Updatepanel extends JPanel{
	...
	/**
	 * This is the constructor method for the updating panel. It allows to change the selected applicant's info.
	 */
	...
	public Updatepanel() {
		...
		title.setText("Fill the blanks below to update the applicant selected:");
		title.setFont(font1);
		...
		update = new JButton();
		update.setBounds(575,225,175,50);
		update.setText("update");
		update.setFont(font1);
		update.setActionCommand("updateapplicant");
		...
		back.setText("Back");
		back.setFont(font1);
		back.setActionCommand("backupdate");
